...
describe("htmlElementsFactory function", () => {
    const data = [
      ...
      const dataElements = htmlElementsFactory(data,{element:'article',props:{},styleProps:parentStyle},{
      ...
      test('Should return a empty array with wrong first argument',()=>{
        ...
        const dataElements = htmlElementsFactory([],{element:'article',props:{},styleProps:parentStyle},{
            'title': {element:'h1',props:{className:'style'},styleProps:{
                color: 'yellow'
            }},
            'body': {element:'p',props:{className:'style1'},styleProps:{
      ...
      test('Should return a empty array with wrong second argument',()=>{
        ...
        const dataElements = htmlElementsFactory([],{element:'fdf',props:{},styleProps:parentStyle},{
            'title': {element:'h1',props:{className:'style'},styleProps:{
                color: 'yellow'
            }},
            'body': {element:'p',props:{className:'style1'},styleProps:{
  ...
  test("Should return a Html Element with a wrapper parent given in a string format", () => {
    ...
    const dataElementsWithWrapper = htmlElementsFactory(data,{element:'article',props:{},styleProps:parentStyle},{
      'title': {element:'h1',props:{className:'style'},styleProps:{
          color: 'yellow'
      }},
      'body': {element:'p',props:{className:'style1'},styleProps:{
  ...
  },{element:'main',props:{className: 'mainClass'}, styleProps:{'backgroundColor': 'red'}})
  expect(dataElementsWithWrapper[0] instanceof HTMLElement).toBe(true)
